package pjatk.edu.kacper.finalproject;
...
public class FinalProjectApplication {
    ...
    //Max. punktów: 50
    //Stwórz trzy moduły:
    //Moduł „api-gen” generujący API z specyfikacji OpenApi przy pomocy pluginu OpenApiTools.
    // Następne moduły powinny podpiąć api-gen poprzez pom.xml
    //(skorzystanie z Swagger Editor -5 pkt)
    //Moduł „bookshop”, który umożliwia wyświetlenie,
    // filtrowanie oraz kupienie książki przez zalogowanego użytkownika.
    ...
    //Zaimplementuj metodę przy użyciu biblioteki feign,
    // aby komunikować się z trzecim modułem. (oraz endpoint dla administratora /order-report który ją wywoła)
    //Moduł „book-order” , który przyjmuje listę obiektów {id książki, nazwa, ilość odwiedzin}.
